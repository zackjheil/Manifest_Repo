        ...
        return(
            <div id="text-position">
                ...
                <Accordion defaultActiveKey="0">
                    <Accordion.Toggle as={Button} variant="link" eventKey="1" id="aboutSubtitle"><h5 id="accordionButton">Leads</h5></Accordion.Toggle>
                ...
                <Accordion defaultActiveKey="0">
                    <Accordion.Toggle as={Button} variant="link" eventKey="1" id="aboutSubtitle"> <h5>Designers</h5> </Accordion.Toggle>
                    <div id="contentBox"><Accordion.Collapse eventKey="1">
                        <div id="aboutContent">
                ...
                <Accordion defaultActiveKey="0">
                <Accordion.Toggle as={Button} variant="link" eventKey="1" id="aboutSubtitle"><h5>Developers</h5></Accordion.Toggle>
                    <div id="contentBox"><Accordion.Collapse eventKey="1">
                        <div id="aboutContent">
                            <h5 id="nameHeader">
                                Jem Generalao
