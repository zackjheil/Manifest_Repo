...
function Happy(){
  db.collection('Emoticon').add({
    Id: 0,
    Mood:"Happy",
    Emotion: "data:image/png;base64," ,
  })
  document.getElementById('Emo-Frame').src = db.collection('Emoticon').doc({ Id:1 }).get().then(document => {
    console.log("Cool")
  })
}
...
function Sad(){
  db.collection('Emoticon').add({
    Id: 1,
    Mood:"Sad",
    Emotion: "data:image/png;base64,"
})}
function Confused(){
  db.collection('Emoticon').add({
    Id: 2,
    Mood:"Confused",
    Emotion: "data:image/png;base64,"
  })}
function Angry(){
db.collection('Emoticon').add({
  Id: 3,
  Mood:"Angry",
  Emotion:"data:image/png;base64,"
  })}
function Excited(){
  db.collection('Emoticon').add({
    Id: 4,
   Mood:"Excited",
    Emotion: "data:image/png;base64,"
  })}
function Heartbroken(){
  db.collection('Emoticon').add({
    Id: 5,
    Mood:"Heartbroken",
    Emotion: "data:image/png;base64,"
  })}
function Anxious(){
  db.collection('Emoticon').add({  
  Id: 6,
  Mood: "Anxious",
  Emotion: "data:image/png;base64,"
  })}
function Flustrated(){
  db.collection('Emoticon').add({
    Id: 7,
    Mood: "Flustrated",
    Emotion: "data:image/png;base64,"
})}
